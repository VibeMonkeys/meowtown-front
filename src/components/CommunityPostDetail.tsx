    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-4 mb-6">
        <Button 
          variant="ghost" 
          onClick={onBack}
          className="btn-cute bg-white/80 hover:bg-pink-50 border border-pink-200 w-10 h-10 rounded-full p-0"
        >
      ...
      {/* 게시글 내용 */}
      <div className="card-cute border-0 shadow-cute bg-gradient-to-br from-white to-pink-50">
        <div className="p-6">
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-base text-gray-700 mb-4 leading-relaxed whitespace-pre-wrap">{post.content}</p>
      ...
      {/* 댓글 섹션 */}
      <div className="card-cute border-0 shadow-cute bg-gradient-to-br from-white to-purple-50">
        <div className="p-6">
          ...
          {comments.length === 0 ? (
            <div className="text-center py-8">
              ...
              <p className="text-pink-400">아직 댓글이 없습니다. 첫 번째 댓글을 작성해보세요!</p>
            </div>
          ) : (
                  ...
                  <div className="flex items-start gap-3 p-4 bg-white rounded-lg shadow-sm">
                    ...
                    <div className="flex-1">
                      ...
                      <Button
                        size="sm"
                        variant="ghost"
                        className="text-pink-500 hover:text-pink-600 hover:bg-pink-50 p-1 h-auto"
                  ...
                  {comment.replies && comment.replies.length > 0 && (
                    <div className="ml-8 space-y-2">
                      {comment.replies.map((reply) => (
                        <div key={reply.id} className="flex items-start gap-3 p-3 bg-pink-50 rounded-lg">
                          ...
                          <div className="flex-1">
                            <div className="flex items-center gap-2 mb-1">
                              <span className="font-semibold text-purple-600 text-sm">{reply.author}</span>
